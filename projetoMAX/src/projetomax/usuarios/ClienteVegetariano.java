 ...
 * @author josel
 */
public class ClienteVegetariano extends Pessoa{
    ...
    public ClienteVegetariano(){
        this.status = "Ativo";
    }
    public ClienteVegetariano(String descricao, String receitaMedica, Pessoa nutricionista){
