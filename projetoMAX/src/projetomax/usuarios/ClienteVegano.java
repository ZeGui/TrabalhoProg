 ...
 * @author josel
 */
public class ClienteVegano extends Pessoa implements IAlimento{
    ...
    public ClienteVegano(){
        
    }
    public ClienteVegano(String descricao, String receitaMedica, Pessoa nutricionista){
